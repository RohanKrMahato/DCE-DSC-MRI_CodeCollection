...
class acquisition_parameters:
  def __init__(self):
    ...
    self.FA1 = 4./180*3.14159 #FA in radian (low FA for T1 estimation)
...
class Hyperparams:
  def __init__(self):
    ...
    self.lsq = True
    self.jobs = 8
    self.model = 'Cosine8' #or Cosine4 --> Cosine8 is a more elaborate model for the AIF
