...
def setup_module(module):
    ...
    log_init(filename_prefix, '_preclinical_AIF_ST_USyd_AUS', ['label', 'time (us)', 'time_ref', 'aif_ref', 'cb_measured'])
...
def test_preclinical_AIF_ST_Sydney_AUS(label, time, cb_ref_values, delay,
    ...
    log_results(filename_prefix, '_preclinical_AIF_ST_USyd_AUS', row_data)
